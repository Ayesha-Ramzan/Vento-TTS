...
// 2. Remove AccentChanger component
const accentStart = html.indexOf('// ============================================\n// ACCENT CHANGER');
const voiceAssistantStart = html.indexOf('// ============================================\n// VOICE ASSISTANT');
...
html = html.slice(0, accentStart) + cameraOCR + html.slice(voiceAssistantStart);

// 3. Add OCR button to TextToSpeech
